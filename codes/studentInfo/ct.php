...
<script src="js_scripts/ctScript.js"></script>
...
function getStuMark($bctId, $stu_id)
{
    ...
    $term = "mid";
    $sql = "SELECT `id`, `co1`, `co2`, `co3`, `co4`, `co5`, `total`, `term`, `bct_id`, `stu_id` FROM `classtest` 
...
function newStu($bctId, $stu_id)
{
    ...
    $term = "mid";
    $sql = "INSERT INTO `classtest`(`co1`, `co2`, `co3`, `co4`, `co5`, `total`, `term`, `bct_id`, `stu_id`) VALUES 
